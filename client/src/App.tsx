...
import {Physics, CuboidCollider, RapierRigidBody} from "@react-three/rapier";
...
import MotorcycleTest from "./scenes/MotorcycleTest";
...
function App() {
    ...
    /*
    return (
        <Canvas style={{height:800, width:800}} camera={{rotation:[0,0,0]}}>
            <MotorcycleTest/>
        </Canvas>
    )
    */
